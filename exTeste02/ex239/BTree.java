...
public class BTree<T> {   
   ...
   public int count(BTNode<T> n){
      ...
      if (n.getLeft() != null && n.getRight() != null) return count(n.getLeft()) + count(n.getRight());
   ...
   public int level(BTNode<T> n, T v, int depth){
      if( n == null ) return -1;
      if(n.getValue() == v) return depth;
      int n1 =level(n.getLeft(), v, depth+1);
      int n2 =level(n.getRight(), v, depth+1);
      if (n1 == -1 || n2 == -1) return Math.max(n1, n2);
